...
"
" Notes:
" This vimrc is tailored for use with neovim.
" See https://github.com/neovim/neovim for installing neovim.
"
" ============================== Keyboard shortcuts ==========================
" Key           Filetype        Action
" F1
...
if empty(glob("~/.local/share/nvim/site/autoload/plug.vim"))
    ...
    execute '!mkdir -p ~/.local/share/nvim/site/plugins'
endif

" Include plugins
source $HOME/.local/share/nvim/site/plugins.vim
